...
// Importez Stimulus et ses helpers Webpack
...
// Chargez tous les contrôleurs Stimulus à partir du dossier "./controllers"
...
var _default = /*#__PURE__*/function (_Controller) {
  ...
  return _createClass(_default, [{
    ...
    value: function () {
      var _increaseQuantity = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var itemId, itemElement, quantityElement, priceElement, currentQuantity, unitPrice, newPrice;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              itemId = event.target.dataset.itemId; // Récupérer l'ID de l'article
              itemElement = this.itemTargets.find(function (target) {
                return target.dataset.itemId === itemId;
              });
              quantityElement = itemElement.querySelector('.item-quantity'); // Élément pour afficher la quantité
              priceElement = itemElement.querySelector('.item-price'); // Élément pour afficher le prix
              currentQuantity = parseInt(quantityElement.innerText); // Quantité actuelle de l'article
              unitPrice = parseFloat(priceElement.dataset.price); // Récupérer le prix unitaire du manga
              // Incrémenter la quantité
              currentQuantity++;
              quantityElement.innerText = currentQuantity; // Mettre à jour la quantité affichée

              // Mettre à jour le prix de l'article (prix unitaire * nouvelle quantité)
              newPrice = (unitPrice * currentQuantity).toFixed(2);
              priceElement.innerText = "".concat(newPrice, " \u20AC");
            case 10:
            case "end":
      ...
      function increaseQuantity(_x) {
        return _increaseQuantity.apply(this, arguments);
      }
    ...
    value: function () {
      var _decreaseQuantity = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var itemId, itemElement, quantityElement, priceElement, currentQuantity, unitPrice, newPrice;
...
_defineProperty(_default, "targets", ['item', 'quantity', 'price', 'total']);
